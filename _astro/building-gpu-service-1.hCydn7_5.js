import{c as t,r as s,m as a}from"./render-template.rCiCpz-f.js";import{u as r}from"./hoisted.6ZpvY2Zp.js";import"./astro/assets-service.wdzbVTWi.js";const o=`<h3 id="our-driving-example">Our Driving Example</h3>
...
</ul>`,n={title:"Building a GPU SaaS Platform - Getting Started",publishDate:"18 December 2023",description:"In this series of articles, I will share my experience of building a GPU SaaS platform from scratch. ",tags:["GPU","SaaS","Kubernetes","Ceph"],minutesRead:"3 min read"},i="/home/runner/work/lokiwager.github.io/lokiwager.github.io/src/content/post/building-gpu-service-1.md",l=void 0;function g(){return`
### Our Driving Example
...
`}function w(){return o}function b(){return[{depth:3,slug:"our-driving-example",text:"Our Driving Example"},{depth:3,slug:"what-should-our-gpu-saas-platform-do",text:"What should our GPU SaaS platform do?"},{depth:3,slug:"coming-up-next",text:"Coming Up Next"}]}const y=t((h,u,c)=>{const{layout:d,...e}=n;return e.file=i,e.url=l,s`${a()}${r(o)}`});export{y as Content,w as compiledContent,y as default,i as file,n as frontmatter,b as getHeadings,g as rawContent,l as url};
