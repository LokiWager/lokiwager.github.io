import{s as F,g as c}from"./_astro_assets.0UhgFKBf.js";import{c as y,r as h,m as d}from"./render-template.rCiCpz-f.js";import{u}from"./hoisted.6ZpvY2Zp.js";import"./astro/assets-service.wdzbVTWi.js";const f={src:"/_astro/Phenomenon.T5BBGCJ2.png",width:946,height:644,format:"png"},g={src:"/_astro/architecture.RS8kTfPP.png",width:2032,height:737,format:"png"},m=async function(t){const s={};{const o=new RegExp('__ASTRO_IMAGE_="([^"]*\\./img/golang-http-url/Phenomenon\\.png[^"]*)"',"g");let a,e=0;for(;(a=o.exec(t))!==null;){const n="./img/golang-http-url/Phenomenon.png_"+e,l=JSON.parse(a[1].replace(/&#x22;/g,'"')),{src:r,...p}=l;s[n]=await c({src:f,...p}),e++}}{const o=new RegExp('__ASTRO_IMAGE_="([^"]*\\./img/golang-http-url/architecture\\.png[^"]*)"',"g");let a,e=0;for(;(a=o.exec(t))!==null;){const n="./img/golang-http-url/architecture.png_"+e,l=JSON.parse(a[1].replace(/&#x22;/g,'"')),{src:r,...p}=l;s[n]=await c({src:g,...p}),e++}}return s};async function C(t){return m(t).then(s=>t.replaceAll(/__ASTRO_IMAGE_="([^"]+)"/gm,(o,a)=>{const e=JSON.parse(a.replace(/&#x22;/g,'"')),n=e.src+"_"+e.index;s[n].srcSet&&s[n].srcSet.values.length>0&&(s[n].attributes.srcset=s[n].srcSet.attribute);const{index:l,...r}=s[n].attributes;return F({src:s[n].src,...r})}))}const i=await C(`<p>I recently encountered an interesting issue that I thought the steps I took to troubleshoot might be worth sharing. I use an open-source project
...
`}function I(){return i}function q(){return[{depth:3,slug:"prepare-the-minimal-environment",text:"Prepare the minimal environment"},{depth:3,slug:"the-root-cause",text:"The root cause"}]}const A=y((t,s,o)=>{const{layout:a,...e}=w;return e.file=B,e.url=x,h`${d()}${u(i)}`});export{A as Content,I as compiledContent,A as default,B as file,w as frontmatter,q as getHeadings,R as rawContent,x as url};
