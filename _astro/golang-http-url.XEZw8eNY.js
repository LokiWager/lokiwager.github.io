import{s as l,g as o}from"./_astro_assets.htesYFOm.js";import{c as p,r as c,m as i}from"./render-template.mrhESvQ5.js";import{u as F}from"./hoisted.5ITtbDzT.js";import"./astro/assets-service.1mn5GyWb.js";const h={src:"/_astro/Phenomenon.T5BBGCJ2.png",width:946,height:644,format:"png"},d={src:"/_astro/architecture.RS8kTfPP.png",width:2032,height:737,format:"png"},y=async function(){return{"./img/golang-http-url/Phenomenon.png":await o({src:h}),"./img/golang-http-url/architecture.png":await o({src:d})}};async function u(n){return y().then(s=>n.replaceAll(/__ASTRO_IMAGE_="([^"]+)"/gm,(r,e)=>l({src:s[e].src,...s[e].attributes})))}const t=await u(`<h2 id="a-fun-bug-with-golangs-httpurl">A Fun “Bug” with Golang’s http.URL</h2>
