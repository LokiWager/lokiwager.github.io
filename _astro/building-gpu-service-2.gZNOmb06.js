import{s as g,g as l}from"./_astro_assets.0UhgFKBf.js";import{c as u,r as m,m as d}from"./render-template.rCiCpz-f.js";import{u as p}from"./hoisted.6ZpvY2Zp.js";import"./astro/assets-service.wdzbVTWi.js";const f={src:"/_astro/part2-stock.LXGy3miQ.png",width:3457,height:1706,format:"png"},v={src:"/_astro/part2-user.O9Ternjq.png",width:3002,height:2319,format:"png"},U={src:"/_astro/part2-storage.ADlGkIpz.png",width:2975,height:1028,format:"png"},P=async function(a){const t={};{const i=new RegExp('__ASTRO_IMAGE_="([^"]*\\./img/gpu-service/part2-stock\\.png[^"]*)"',"g");let s,e=0;for(;(s=i.exec(a))!==null;){const n="./img/gpu-service/part2-stock.png_"+e,r=JSON.parse(s[1].replace(/&#x22;/g,'"')),{src:c,...o}=r;t[n]=await l({src:f,...o}),e++}}{const i=new RegExp('__ASTRO_IMAGE_="([^"]*\\./img/gpu-service/part2-user\\.png[^"]*)"',"g");let s,e=0;for(;(s=i.exec(a))!==null;){const n="./img/gpu-service/part2-user.png_"+e,r=JSON.parse(s[1].replace(/&#x22;/g,'"')),{src:c,...o}=r;t[n]=await l({src:v,...o}),e++}}{const i=new RegExp('__ASTRO_IMAGE_="([^"]*\\./img/gpu-service/part2-storage\\.png[^"]*)"',"g");let s,e=0;for(;(s=i.exec(a))!==null;){const n="./img/gpu-service/part2-storage.png_"+e,r=JSON.parse(s[1].replace(/&#x22;/g,'"')),{src:c,...o}=r;t[n]=await l({src:U,...o}),e++}}return t};async function G(a){return P(a).then(t=>a.replaceAll(/__ASTRO_IMAGE_="([^"]+)"/gm,(i,s)=>{const e=JSON.parse(s.replace(/&#x22;/g,'"')),n=e.src+"_"+e.index;t[n].srcSet&&t[n].srcSet.values.length>0&&(t[n].attributes.srcset=t[n].srcSet.attribute);const{index:r,...c}=t[n].attributes;return g({src:t[n].src,...c})}))}const h=await G(`<p>As we discussed in the previous article, we will write a requirement document for our Stable Diffusion WebUI SaaS. This article is not a complete requirement document, but a guide to write a requirement document.</p>
...
design spec. <strong>However, the article is a demo, not enough detailed to be a real requirement spec.</strong></p>`),b={title:"Building a GPU SaaS Platform - The requirement spec",publishDate:"26 February 2024",description:"How to write a requirement document for a GPU SaaS platform, and what should be included in the document.",tags:["GPU","SaaS","Kubernetes","Ceph"],minutesRead:"5 min read"},w="/home/runner/work/lokiwager.github.io/lokiwager.github.io/src/content/post/building-gpu-service-2.md",T=void 0;function S(){return`
