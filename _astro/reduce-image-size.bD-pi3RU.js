import{c as a,r as e,m as p}from"./render-template.5GvZ_d9G.js";import{u as l}from"./hoisted.S6KN3Rcg.js";import"./astro/assets-service.3__6wVx0.js";const n=`<h2 id="how-to-reduce-the-nvidia-docker-image-size">How to reduce the Nvidia Docker image size</h2>
...
<pre class="astro-code dracula" style="background-color:#282A36;color:#F8F8F2; overflow-x: auto; white-space: pre-wrap; word-wrap: break-word;" tabindex="0"><code><span class="line"><span style="color:#50FA7B">docker</span><span style="color:#F1FA8C"> run</span><span style="color:#BD93F9"> --rm</span><span style="color:#BD93F9"> -it</span><span style="color:#BD93F9"> -v</span><span style="color:#F1FA8C"> /var/run/docker.sock:/var/run/docker.sock</span><span style="color:#F1FA8C"> wagoodman/dive:latest</span><span style="color:#F1FA8C"> 10.108.163.251:20443/megaease/sd-cuda118-cudnn8-ubuntu2204:builder</span></span>
<span class="line"></span></code></pre>
